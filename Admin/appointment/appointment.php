...
<div id="wrapper">
    <?php include "../sidebar.php"; ?>
        <section id="content-wrapper">
            <div class="row mx-1">
                <div class="col-lg-12">
                <h1 class="text-purple" style="color:6537AE;">Appointment List</h1>
        ...
        buttons: [
            {
                ...
                customize: function (doc) {
                            // Hide specific columns in the PDF export
                            doc.content[1].table.widths = ['auto', 'auto', 'auto', 'auto', 'auto', 'auto', 'auto']; // Adjust column widths as needed
                            doc.content[1].table.body.forEach(function(row) {
                                row.splice(7, 2); // Remove the 7th and 8th columns
                            });
                        }
                    },
            'copy',
