...
<div class="row imagers">
        ...
        <div class="col">
            <div class="image-wrapper">
                <img src="images/hairservice1.jpg" alt="Image 2">
                <div class="text">Laser Hair Removal</div>
            </div>
        </div>

        <div class="col">
            <div class="image-wrapper">
                <img src="images/hairservice2.jpg" alt="Image 2">
                <div class="text">Face-to-face Hair Consultation</div>
            </div>
        </div>
