...
<div class="tab-content mb-5" id="myTabContent">
  ...
  <?php
    ...
    $stmt = mysqli_prepare($conn, "SELECT id, services, image, description FROM service WHERE services = 'Skin'");
  ...
  <?php
    ...
    $stmt = mysqli_prepare($conn, "SELECT id, services, image, description FROM service WHERE services = 'Face'");
    mysqli_stmt_execute($stmt);
    mysqli_stmt_store_result($stmt);
    mysqli_stmt_bind_result($stmt, $id, $services, $image, $description);
  ...
  <?php
    ...
    $stmt = mysqli_prepare($conn, "SELECT id, services, image, description FROM service WHERE services = 'Nail'");
    mysqli_stmt_execute($stmt);
    mysqli_stmt_store_result($stmt);
    mysqli_stmt_bind_result($stmt, $id, $services, $image, $description);
