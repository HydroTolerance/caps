...
<nav class="navbar navbar-expand-lg" style="background-color: #6537AE; ">
       ...
       <div class="about-container">
        ...
        <div class="doc-container" style="display: flex; padding: 50px; ">
            <div class="doc-text" style="text-align: center;">
                <img src="images/doc.png" alt="Description of the image" width="500" height="300" style="border-radius: 10px;">
            </div>
        ...
        <div class="award1-container" style="display: flex; padding: 50px; background-color:#6537AE; color: white; ">
            <div class="award1-text" style="text-align: center;">
                <img src="images/image16.jpg" alt="Description of the image" width="300" height="300" style="border-radius: 10px;">
            </div>
            <div class="award1-text" style="text-align: left; margin-left: 30px;">
                <p><span style="font-weight: bold; font-size: 35px; font-family: roboto;">Clinical Training Certificate</span></p>
                <br>
                <p style="font-family: poppins; font-size: 20px;">Certificate of attendance for the clinic training on Discovery PICO - Chrome Q-Plus EVO Series to Zharla Gulmatico-Flores MD, MMPHA, FPDS 
                </p>
            </div>
        </div>
        ...
        <div class="missionvision2-container" style="display: flex; padding: 50px; ">
            ...
            <div class="mission-text">
                <img src="images/image14.jpg" alt="Description of the image" width="400" height="400" style="border-radius: 10px;">
            </div>
