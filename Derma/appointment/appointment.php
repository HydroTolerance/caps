...
<div id="wrapper">
    <?php include "../sidebar.php"; ?>
        <section id="content-wrapper">
            <div class="row mx-1">
                <div class="col-lg-12">
                <h1 class="text-purple mt-3" style="color:6537AE;">Appointment</h1>
                <div class="bg-white p-3 rounded-3 border mb-1" style="position: relative;" >
                <div class="row">
                <div class="col-md-6">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                    <tr onclick="showData('<?php echo $row['id']; ?>')">
                        ...
                        <td>
                            <select class="form-select  custom-width text-nowrap" name="status" onchange="updateStatus(<?php echo $row['id']; ?>, this.value)">
